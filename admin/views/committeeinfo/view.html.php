 ...
 * @since  0.0.1
 */
class AuditReportsViewCommitteeInfo extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		$this->items		= $this->get('CommitteeInfo');
		...
		AuditReportsHelper::addSubmenu("committeeinfo");
	...
	{
		JToolBarHelper::title(JText::_('COM_AUDITREPORTS_BOOKINGS'));
