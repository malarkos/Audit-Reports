 ...
 * @since  0.0.1
 */
class AuditReportsViewMemberBalances extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		AuditReportsHelper::addSubmenu("memberbalances");
	...
	{
		JToolBarHelper::title(JText::_('COM_AUDITREPORTS_MEMBERBALANCES'));
