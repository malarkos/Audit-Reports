 ...
 * @since  0.0.1
 */
class AuditReportsViewSubsSummary extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		//$this->subrates 	= $this->get('SubRates');
		...
		AuditReportsHelper::addSubmenu("subssummary");
	...
	{
		JToolBarHelper::title(JText::_('COM_AUDITREPORTS_SUBSSUMMARY'));
