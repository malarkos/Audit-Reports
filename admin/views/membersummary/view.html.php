 ...
 * @since  0.0.1
 */
class AuditReportsViewMemberSummary extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		...
		AuditReportsHelper::addSubmenu("membersummary");
	...
	{
		JToolBarHelper::title(JText::_('COM_AUDITREPORTS_MEMBERSUMMARY'));
