...
class AuditReportsModelMemberMovements extends JModelList
{
	...
	protected function getListQuery()
	{
        ...
        $query->where('MemberJoiningDate > \'2016-11-30\''); // add code to automatically calculate this.
	...
	public function getMembersDeparted()
	{
		...
		$query->from('members AS m');
		$query->where('MemberDepartureDate > \'2016-11-30\''); // add code to automatically calculate this.
	...
	public function getNewFamily() 
	{
		...
		$query->where('FamilyMemberJoinDate > \'2016-11-30\''); // add code to automatically calculate this.
	...
	public function getFamilyDeparted()
	{
		...
		$query->from('familymembers  AS f');
		$query->where('FamilyMemberDepartureDate > \'2016-11-30\''); // add code to automatically calculate this.
